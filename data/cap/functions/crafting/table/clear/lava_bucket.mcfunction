...
execute store result score #t1 capValue run data remove storage cap:cm_replace Items[{id:"minecraft:lava_bucket",Count:1b}]
execute store result score #t2 capValue run data remove storage cap:cm_replace Items[{id:"minecraft:lava_bucket"}]
...
execute as @s[tag=!cap_dist_success] run data remove block ~ ~ ~ Items[{id:"minecraft:lava_bucket",Count:1b}].tag
execute as @s[tag=!cap_dist_success] if data block ~ ~ ~ Items[{id:"minecraft:lava_bucket",Count:1b}] run data modify block ~ ~ ~ Items[{id:"minecraft:lava_bucket",Count:1b}] merge value {id:"minecraft:bucket",Count:2b}
